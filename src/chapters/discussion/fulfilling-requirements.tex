...
This one example fulfills the requirement as class \codeword{B} is still a subclass of class \codeword{A} after both a merge and an addition is made to \codeword{B}.
