...
% TODO: Dette avsnittet ble kanskje litt rart og omstendelig - jeg tror det kunne ha godt av at du leser gjennom en gang til med tanke på en utenforstående leser, og at du arbeider litt mer med formuleringene i teksten.
% TODO: Forklar bedre "legal" reaons to fail, eller omformuler
...
Now that we understand when it should fail let us look at some scenarios where it should not fail.
