...
As we shortly touched on in the introduction, an implementation of Package Template in a language like TypeScript gives rise to some interesting research questions:
