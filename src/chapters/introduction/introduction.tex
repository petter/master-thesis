...
% TODO skriv noe mer introduksjon ala reuse og modularization er viktig på grunn av sånn og slik. Det har blitt forsket på av mange, og gitt opphav til mekanismer som Traits, Mixins, ClassBoxes, osv.

%Re-use is immensely important in software development, and has been extensively researched.
%re-use and modularization helps projects stay scaleable.
%By splitting up code into modules we are able to re-use the piece of code.
%If the piece of code at a later is improved upon, then all the re-uses will also benefit from this.
%Modularization also helps in writing clean code
