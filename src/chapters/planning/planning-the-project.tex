...
In order to perform a rename we will need to rename the declaration, and find all references to this declaration and also rename these.
...
\begin{itemize}
    \item Implementing as a TypeScript library
...
We will be making a custom compiler for a superset of TypeScript with the addition of the language mechanism Package Templates.
