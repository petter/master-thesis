...
What this means is that any additions made to a superclass will also be reflected in its subclasses, we do not have to worry about how the class is being used.
...
This form of inheritance is different from what you would normally find in Java, it acts more like \texit{mixins}\footnote{A mixin is a language feature which enables you to inject code into a class.}.
