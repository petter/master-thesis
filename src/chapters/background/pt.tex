...
This might seem harsh at first, but it is still possible to implement interfaces outside the template, and this should circumvent most of the drawbacks this restrictions places upon us.
