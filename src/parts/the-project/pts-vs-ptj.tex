...
\begin{code}{Java}{Example of subtype relations in nominal and structural typing, with a Java-like language.}{lst:subtype}
    // Given the class A
    class A {
        void f() { ... }
     }
...
\begin{code}{TypeScript}{Usage of a recursive type, BinTree, in TypeScript}{lst:ts-recursive-type}
    interface BinTree<T> {
        getData(): T;
...
\begin{code}{Java}{Example of a nominally typed program in Java}{lst:nominal-typing-example}
